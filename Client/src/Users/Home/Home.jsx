...
const editerData= response.data.user
 ...
 toast.success("you are editer the details  ", {
  position: "top-center",
  autoClose: 2000,
});
  ...
  return (
    <div className="home-container">
      ...
      <div className="user-details">
        <img src={data[0]?data[0].image:null}
alt="User" className="user-image" />
        <p><strong>Username:{storedata[0]?storedata[0].username:null}</strong> </p>
        <p><strong>Email:{storedata[0]?storedata[0].email:null}</strong> </p>
